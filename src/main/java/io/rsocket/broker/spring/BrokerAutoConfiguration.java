...
import io.rsocket.broker.rsocket.*;
import io.rsocket.broker.spring.cluster.*;
...
public class BrokerAutoConfiguration implements InitializingBean {
	...
	public BrokerRSocketServerBootstrap proxyRSocketServerBootstrap(
		...
		return new BrokerRSocketServerBootstrap("io/rsocket/broker", findTransportName(properties.getUri()), serverFactory, brokerSocketAcceptor);
	}
